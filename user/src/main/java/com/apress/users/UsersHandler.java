...
@RequiredArgsConstructor
    ...
    public class UsersHandler {
        ...
        public ServerResponse findUserByEmail(ServerRequest request) {
            return ServerResponse
                    .ok()
                    .contentType(MediaType.APPLICATION_JSON)
                    .body(this.userRepository.findById(request.
                            pathVariable("email")));
        }
        public ServerResponse save(ServerRequest request) throws
                ServletException, IOException {
            Users user = request.body(Users.class);
    ...
    private BindingResult validate(Users user) {
        DataBinder binder = new DataBinder(user);
        binder.addValidators(validator);
        binder.validate();
        return binder.getBindingResult();
    }
    private ServerResponse prepareErrorResponse(BindingResult
                                                        bindingResult) {
